                        ...
                        {#each Object.keys(mountainIntersectionMap) as key (key)}
                            <!-- {#key intersectionMap[key]} -->
                                ...
                                <!-- <div class="_relative"> -->
                                    ...
                                    <svg data-width="547" data-height="453" viewBox="0 0 547 453" fill="none" xmlns="http://www.w3.org/2000/svg" class="absolute top-0 left-1/2 -translate-x-1/2 lg:-translate-x-2/3 text-white max-lg:origin-top max-lg:translate-y-1/3 max-lg:scale-y-150">
